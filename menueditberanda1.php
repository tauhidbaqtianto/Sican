...
<div class="range range-sm-center">
  <div class="cell-sm-10 cell-md-8 cell-lg-6">
        ...
        <br>
  <form method="post" enctype="multipart/form-data" action="uploadberanda1.php">
    <p>Gambar 1</p>
    <input type="file" name="gambarberandahead">
    <br>
    <p>Gambar 2</p>
    <input type="file" name="gambarberandahead2">
    <br>
    <p>Gambar 3</p>
    <input type="file" name="gambarberandahead3">
    <br>
    <p>Gambar 4</p>
    <input type="file" name="gambarberandahead4">
    <br>
