              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="active"><a href="about-me.php">Tentang<span></span><span></span><span></span><span></span></a>
                    </li>
                    <li><a href="typography.php">Artikel<span></span><span></span><span></span><span></span></a>
                    </li>
            ...
            <div class="cell-sm-6 cell-md-7">
              <div class="box-width-3 box-centered">
                <article class="quote-big">
                  <p class="q">Logo dan Makna</p>
                </article>
                <div class="divider"></div>
                <p class="text-spacing-05">Yayasan Cipta Asa Nusantara terdiri dari tiga suku kata, yakni:<br>
1. Cipta diartikan sebagai Sang pencipta/Tuhan.<br>
2. Asa diartikan sebagai sebuah harapan/impian/cita-cita.<br>
3. Nusantara diartikan dengan Seluruh penjuru negeri.<br>
<br>
...
Arti warna dalam logo Yayasan CAN. terdapat dua warna utama dalam logo CAN, yaitu warna hijau muda dan biru tua. Warna Hijau muda berarti damai, tumbuh & tenang. Sedangkan warna biru tua berarti kuat, terpercaya, tanggung jawab & professional.</p>
<!--                <div class="group-3-columns" data-lightgallery="group">
      ...
      <section class="section section-md bg-white">
        <div class="shell">
          <div class="range range-50 range-sm-center range-md-left">
            <div class="cell-sm-6 cell-md-5">
              <div class="thumb-bordered"><img src="images/about-2-437x435.jpg" alt="" width="437" height="435"/>
              </div>
            </div>
            <div class="cell-sm-6 cell-md-7">
              <div class="box-width-3 box-centered">
...
<!--                <div class="group-3-columns" data-lightgallery="group">
      ...
      <section class="section section-md bg-white">
        <div class="shell">
          <div class="range range-50 range-sm-center range-md-left">
            <div class="cell-sm-6 cell-md-5">
              <div class="thumb-bordered"><img src="images/about-4-437x435.jpg" alt="" width="437" height="435"/>
              </div>
            </div>
            <div class="cell-sm-6 cell-md-7">
              <div class="box-width-3 box-centered">
                <article class="quote-big">
                  <p class="q">Struktur</p>
                </article>
                <div class="divider"></div>
                <p class="text-spacing-05">
Yayasan Cipta Asa Nusantara terdiri dari 7 orang antara lain sebagai berikut:<br>

Pendiri : Budyanto Totong<br>
Pembina : Lily Suryana Totong<br>
Pengawas : Dr. Ir. Johannes Radjagukguk<br>
<br>
Pengurus<br>
Ketua Umum : Jani S. Wowiling<br>
Ketua I : Sri Hati Siagian<br>
Ketua II : Kwet Khiong<br>
Sekretaris : Vera Marlina Munaiseche<br>
Bendahara : Eddy Santoso<br>
</p><!--
                <div class="group-3-columns" data-lightgallery="group">
                  <div class="column-item"><a class="thumb-light" href="images/certificate-1-847x1200.jpg" data-lightgallery="item"><img src="images/certificate-1-120x171.jpg" alt="" width="120" height="171"/>
                      <div class="thumb-light__overlay"></div></a></div>
...
<section class="section section-md bg-white">
        <div class="shell">
          <div class="range range-50 range-sm-center range-md-left">
            <div class="cell-sm-6 cell-md-5">
              <div class="thumb-bordered"><img src="images/about-3-437x435.jpg" alt="" width="437" height="435"/>
              </div>
            </div>
            <div class="cell-sm-6 cell-md-7">
              <div class="box-width-3 box-centered">
                <article class="quote-big">
                  <p class="q">Visi, Misi & Nilai</p>
                </article>
                <div class="divider"></div>
                <p class="text-spacing-05"><h4>Visi</h4>Menjadi lembaga yang peduli dan berperan aktif terhadap Pendidikan, Keluarga & Sosial Kemanusiaan.<br>
                <br><h4>Misi</h4>1. Mendirikan & menyelenggarakan Pendidikan formal PAUD, SD, SMP & SMA.<br>
2. Menyelenggarakan pelatihan & pembinaan sosial (Eks. Napi, KDRT, Korban Pelecehan Seksual & Narkoba.<br>
3. Cepat tanggap terhadap korban bencana alam<br>
<br><h4>Nilai</h4>
C : Cepat Tanggap<br>
A : Andalan<br>
N : Nyata Solusinya<br>
                </p><!--
                <div class="group-3-columns" data-lightgallery="group">
                  <div class="column-item"><a class="thumb-light" href="images/certificate-1-847x1200.jpg" data-lightgallery="item"><img src="images/certificate-1-120x171.jpg" alt="" width="120" height="171"/>
                      <div class="thumb-light__overlay"></div></a></div>
        ...
        <div class="shell">
          <div class="range range-50 range-sm-center">
            <div class="cell-md-10 cell-lg-9">
              ...
              <p>In my portfolio, there are hundreds of successful photo shoots and dozens of satisfied customers. All of the couples I’ve been working with were more than satisfied with my works. Check out the gallery to learn more about my skills and style.</p>
            </div>
          </div>
        </div>-->
        <!-- Owl Carousel--><!--
