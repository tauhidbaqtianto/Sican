              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    <li>Menu Edit<span></span><span></span><span></span><span></span>
                    </li>
                  </ul>
                </div>
              </div>
...
<div class="range range-sm-center">
  <div class="cell-sm-10 cell-md-8 cell-lg-6">
        ...
        <br>
  <form method="post" enctype="multipart/form-data" action="uploadberanda.php">
    <p>Gambar 1</p>
    <input type="file" name="gambarberandaportofolio">
    <br>
    <p>Gambar 2</p>
    <input type="file" name="gambarberandaportofolio2">
    <br>
    <p>Gambar 3</p>
    <input type="file" name="gambarberandaportofolio3">
    <br>
    <p>Gambar 4</p>
    <input type="file" name="gambarberandaportofolio4">
    <br>
