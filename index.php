                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-element">
                    <ul class="list-icons list-inline-sm">
                      ...
                      <li><a class="icon icon-sm fa fa-user icon-style-camera" href="login.php"><span></span><span></span><span></span><span></span></a></li>
                    </ul>
                  </div>
                  <!-- RD Navbar Nav-->
                  <ul class="rd-navbar-nav">
                    <li class="active"><a href="index.php">Beranda<span></span><span></span><span></span><span></span></a>
                    </li>
