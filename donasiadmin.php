  ...
  <body>
    ...
    <div class="page">
              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    <li><a href="indexadmin.php">Beranda<span></span><span></span><span></span><span></span></a>
                    </li>
                    ...
                    <li class="active"><a href="donasiadmin.php">Donasi<span></span><span></span><span></span><span></span></a>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <section class="breadcrumbs-custom bg-image" style="background-image: url(images/breadcrumbs-image.jpg);">
        <div class="shell">
          <h1 class="breadcrumbs-custom__title">Donasi</h1>
...
-->
      ...
      <section class="section section-md bg-white text-center">
        <div class="shell-fluid">
          <p class="heading-1">Mari Berdonasi</p>
          <p><span class="box-width-2">Untuk Berdonasi silahkan transfer melalui rekening yang tersedia , atau dengan scan barcode yang ada di bawah ini</span></p>
          <div class="isotope thumb-ruby-wrap wow fadeIn" data-isotope-layout="masonry" data-isotope-group="gallery" data-lightgallery="group">
            <div class="row">
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 isotope-item"><a class="thumb-ruby thumb-mixed_height-2 thumb-mixed_md" href="images/gambar.jpg" data-lightgallery="item"><img class="thumb-ruby__image" src="images/gambar.jpg" alt="" width="440" height="327"/>
                        <div class="thumb-ruby__caption"> 
                          <p class="thumb-ruby__title heading-3">BCA</p>
                        </div></a>
              </div>
              <!--
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 isotope-item"><a class="thumb-ruby thumb-mixed_height-2 thumb-mixed_md" href="images/gambar2.jpg" data-lightgallery="item"><img class="thumb-ruby__image" src="images/gambar2.jpg" alt="" width="440" height="327"/>
                        <div class="thumb-ruby__caption"> 
                          <p class="thumb-ruby__title heading-3">Gopay</p>
                        </div></a>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 isotope-item"><a class="thumb-ruby thumb-mixed_height-2 thumb-mixed_md" href="images/gambar3.jpg" data-lightgallery="item"><img class="thumb-ruby__image" src="images/gambar3.jpg" alt="" width="440" height="327"/>
                        <div class="thumb-ruby__caption"> 
                          <p class="thumb-ruby__title heading-3">Ovo</p>
                        </div></a>
              </div>
              <!--
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 isotope-item"><a class="thumb-ruby thumb-mixed_height-2 thumb-mixed_md" href="images/gambar4.jpg" data-lightgallery="item"><img class="thumb-ruby__image" src="images/gambar4.jpg" alt="" width="440" height="327"/>
                        <div class="thumb-ruby__caption"> 
                          <p class="thumb-ruby__title heading-3">Dana</p>
                        </div>
              </div>
          </div>
        </div>
        <div>
          <center><button><a href="menuedit.php"> edit</a></button></center>
        </div>
      </section>
      <!-- Bottom Banner-->
      <!-- Page Footer-->
          ...
          <div class="range range-sm-center">
            <div class="cell-sm-10 cell-md-8 cell-lg-6">
              <!-- Brand--><a class="brand" href="index.html">
                <div class="brand__name"><img src="images/logo-inverse.png" alt="" width="237" height="35"/></div>
                <span class="brand__slogan">Cipta Asa Nusantara</span></a>
                    <!-- RD Mailform-->
