...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../si/css/bootstrap.css">
...
<div class="range range-sm-center">
  <div class="cell-sm-10 cell-md-8 cell-lg-6">
    <!--<form action="donasiadmin.php" action="donasi.php" method="post">
        <textarea class="ckeditor" name="isi" id="isi" value="<?php //echo $isi["isi"];?>"></textarea>
              <br>
            <button class="tombol" name="simpan" value="simpan">Simpan</button>
          <br>
        <br>
      </form>-->
